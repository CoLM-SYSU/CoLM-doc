...
\begin{equation}
u(z)=f_{c} \cdot \min \big(u_{\exp }(z), u_{comb}(z)\big)+\left(1-f_{c}\right) \cdot u_{comb}
\end{equation}
\begin{equation}
\frac{1}{K(z)}=f_{c} \cdot \frac{1}{\min \big(K_{\exp}(z), K_{comb}(z)\big)}+\left(1-f_{c}\right) \cdot \frac{1}{K_{comb}}
\end{equation}
