...
\esection{Black Carbon and Dust in Snow}
\begin{mymdframed}{代码}
  本节对应的代码文件为\texttt{MOD\_SoilSnowHydrology.F90}。
\end{mymdframed}
...
\esubsection{Metamorphism-Induced Compaction}
...
\esubsection{Load-Induced Compaction}
...
\esubsection{Melt-Induced Compaction}
...
\subsection{风吹雪引起的压实}
\esubsection{Wind-Induced Compaction}
...
\esection{Snow Layer Re-formation}
\begin{mymdframed}{代码}
  本节对应的代码文件为\texttt{MOD\_SnowLayersCombineDivide.F90}。
\end{mymdframed}
