...
\hline \multicolumn{1}{c}{\textbf{驱动名}} & \multicolumn{1}{c}{\textbf{分辨率}} & \multicolumn{1}{c}{\textbf{时间范围}} & \multicolumn{1}{c}{\textbf{空间范围}} & \multicolumn{1}{c}{\textbf{参考文献}} & \multicolumn{1}{c}{\textbf{附加说明}} \\ \hline 
\endfirsthead
...
\end{equation}
其中$a_0$=0.17639, $a_1$=0.0038, $a_2$=-9.0039\times{10}$^{-6}$,$a_3$=8.1351\times{10}$^{-9}$, $b_0$=0.29548, $b_1$=0.00504, $b_2$=-1.4957\times{10}$^{-5}$,$b_3$=1.4881\times{10}$^{-8}$。这些系数来自对NCAR-CAM模式模拟结果的拟合。
\\
\\
