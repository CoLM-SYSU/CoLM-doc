...
\begin{equation}
\begin{aligned}
 fracice_{sub}&=\frac{\exp \left[-3 \times\left(1-\frac{i c e f r a c s u m}{d z s u m}\right)\right]
    -\exp (-3)}{1-\exp (-3)} \\
 f_{imped}&=1- { fracice }_{sub} \\
 q_{drai}&=f_{imped} \times q_{drai,max} 
    \exp \left(-f_{d r a i} \times z_{w t}\right)
\end{aligned}
\end{equation}
